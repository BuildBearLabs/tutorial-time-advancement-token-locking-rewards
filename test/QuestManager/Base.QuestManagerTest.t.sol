...
contract QuestManagerTest is Test {
    ...
    address owner = address(0xB80D90fcf2Ed0e4FeBE02d2a209109Bf1F62DF95);
    address admin1 = address(0x428AB2BA90Eba0a4Be7aF34C9Ac451ab061AC010);
    address admin2 = address(0x310fbFE67D134f952571287a75f9F4031FA70A9A);
    address user1 = address(0x4bF88042De0220647ACb314AF3c5F310AEc3bCc0);
    address user2 = address(0xE894575004113373d68535Ee8e0b7e880278DcF9);
    address user3 = address(0x386d6219e399Cf9ADCE59C493B90cAc42dEeDfE2);
    address user4 = address(0xc18DAD44E77Cf2f2F689F68d93a3603cBcDC5A30);
    ...
    function setUp() public {
        baseMainnetFork = vm.createFork("https://base.meowrpc.com");
