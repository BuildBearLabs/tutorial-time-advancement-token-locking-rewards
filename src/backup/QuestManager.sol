...
/**
 * @title QuestManager without Signature Verification
 * @author 0xJustUzair
 * @notice THIS CONTRACT IS FOR DEMO PURPOSES ONLY TO TEST THE LOGIC OF THE MAIN CONTRACT
 */
contract QuestManager is Ownable {
    ...
    */
    ...
    @params - communityID: unique identifier for the community or project
    ...
    */
    ...
    // tokenAddresses is used to map the token name to the token address
    mapping(string tokenSymbol => address token) public tokenAddresses;
    ...
    function claimRewardsOnBehalfOfWinner(string memory _id, address payable winner) external _onlyAdminOrOwner {
